        ...
        <section className="hero chapter" id="context">
          ...
          <div className="scope-block">
            <div className="scope-copy">
              ...
              <p>
                My experience has been across banking platforms, modernisation, financial workflows, transaction/payment dependencies and integrations around authoritative banking systems. <strong>I have not personally administered an end-to-end Corniche implementation.</strong>
              </p>
              <p>
                That distinction matters, so I wanted to correct it explicitly rather than leave ambiguity.
              </p>
              <p>
                Instead of trying to explain the wording further, I built this artifact to show the underlying domain understanding, what I have actually done, and how I would approach Avarda’s environment.
              </p>
            </div>
