...
import { chapters, sources, transferRows } from '../content'
import {
  Arrow,
  ChapterHeader,
  DecisionEngine,
...
export function DeepDive() {
  ...
  return (
    <div className="deepdive-shell">
      <div className="reading-progress-track" style={{ '--progress': `${progress}%` } as React.CSSProperties} />
      ...
      <main>
        <section className="hero chapter" id="context">
          <div className="hero-grid">
            <div className="hero-copy">
              ...
              <a className="primary-link" href="#explorer" onClick={(event) => { event.preventDefault(); document.getElementById('explorer')?.scrollIntoView({ behavior: 'smooth' }) }}>
          ...
          <div className="scope-block" id="scope">
            <div className="scope-copy">
              <p className="eyebrow">SCOPE CLARIFICATION</p>
              <h2>My Corniche experience, stated precisely.</h2>
              <p>
                After our conversation, I want to state my Corniche experience precisely, so there is no ambiguity.
              </p>
              <p>
                I have <strong>interacted with Corniche in a partner-bank context and worked to understand its configuration.</strong> I have not owned or run the end-to-end administration of a Corniche implementation, and I do not want my wording to imply that.
              </p>
              <p>
                That is a real but bounded exposure. This artifact shows the domain understanding behind it, what I have actually done, and how I would approach Avarda’s environment.
              </p>
            </div>
        ...
        <section className="chapter closing" id="close">
          ...
          <div className="closing-copy">
            <p>
              The distinction I wanted to make after our conversation is simple: my Corniche experience is real but bounded. I interacted with it in a partner-bank context and worked to understand its configuration, rather than owning its end-to-end administration, and I do not want to represent it as more than that.
            </p>
            <p>
